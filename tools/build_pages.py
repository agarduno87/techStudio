...
PAGES = [
    ...
    },
    {
        ...
        "faq": [
            ...
            ("How much does an automation project cost?",
             ...
             "An MVP typically starts around USD 2,000 and the exact figure depends on how many systems it has to touch. The assessment that precedes it starts around USD 500 and you keep the roadmap either way.",
             "Un MVP arranca típicamente alrededor de USD 2,000 y la cifra exacta depende de cuántos sistemas tenga que tocar. El diagnóstico previo arranca alrededor de USD 500 y te quedas con la hoja de ruta pase lo que pase."),
    ...
    },
    {
        "slug": "data-analytics",
        "num": "04",
        "title_en": "Data and Analytics Consulting: Dashboards, Pipelines and Reporting You Can Defend",
        "title_es": "Consultoría de datos y analítica: dashboards, pipelines y reporteo que puedes defender",
        "desc_en": "Data pipelines, operational dashboards and scheduled reporting, with metric definitions agreed with the business and the queries handed over with the analysis.",
        "desc_es": "Pipelines de datos, dashboards operativos y reporteo en calendario, con las definiciones de métricas acordadas con el negocio y las consultas entregadas junto con el análisis.",
        ...
        "in": [
            ("Data pipelines, cleaning and consolidation across sources",
             "Pipelines de datos, limpieza y consolidación entre fuentes"),
            ("Operational dashboards and scheduled reporting",
             "Dashboards operativos y reporteo en calendario"),
            ("Metric definitions agreed and documented with the business",
             "Definiciones de métricas acordadas y documentadas con el negocio"),
            ("Analysis delivered together with the queries behind it",
             "Análisis entregado junto con las consultas que lo produjeron"),
        ],
        "out": [
            ("Enterprise data-warehouse migrations",
             "Migraciones de data warehouse corporativo"),
